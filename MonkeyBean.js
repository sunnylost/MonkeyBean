...
(function(window, $, undefined) {
    ...
    MonkeyModule('MonkeySearch', {
        ...
        render : function() {
            ...
            this.el.append('<ul id="MonkeySearchList">\
                                ...
                                <li><a href="http://ishare.iask.sina.com.cn/search.php?key={gb:word}">新浪爱问</a></li>\
                                <li><a href="http://wenku.baidu.com/search?word={gb:word}">百度文库</a></li>\
                                ...
                                <li><a href="http://www.douban.com/group/search?q={word}">豆瓣小组</a></li>\
